############# FUll Growth Rate R Code (Finally) ##################
...
GRData <- read.csv("C:/Users/User/Documents/Edi Masters/Master's Research Project/B158237Dissertation/GRData.csv", header = TRUE)
